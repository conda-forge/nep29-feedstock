...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nep29-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15209&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nep29-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nep29` can be installed with:

```
conda install nep29
```

It is possible to list all of the versions of `nep29` available on your platform with:
